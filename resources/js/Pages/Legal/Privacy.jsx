            ...
            <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-10">
                ...
                <div className="space-y-8 text-xs sm:text-sm text-violet-100/75 leading-relaxed">
                    ...
                    <section className="space-y-2">
                        ...
                        <p>
                            We collect personal information that you provide when registering: your name, email address, password (hashed using BCRYPT), date of birth (for 18+ verification), phone number, and residence location for billing compliance.
                        </p>
                    </section>
                    ...
                    <section className="space-y-2">
                        ...
                        <p>
                            Under GDPR and California Consumer Privacy Act (CCPA), you have the right to request access, modification, or complete deletion of your personal data at any time by contacting <span className="text-cyan-400 font-bold">privacy@crystalbrawlers.com</span>.
                        </p>
                    </section>
